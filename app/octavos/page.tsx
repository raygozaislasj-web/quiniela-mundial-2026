...
import { partidos } from "../data/octavos";
  ...
  if (cargando) {
    ...
    <main className="max-w-7xl mx-auto p-6">
      ...
      <p className="text-gray-600 mb-8">
        ...
        Si termina empatado, selecciona quién
        avanza por penales.
      </p>
      ...
      <div className="mt-10 text-center">
        ...
        {!yaEntrego ? (
          ...
          <button
            ...
            className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-4 rounded-xl disabled:opacity-50"
          >
