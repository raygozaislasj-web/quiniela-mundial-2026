    ...
    <FeedbackModal>
      <main className="max-w-7xl mx-auto p-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link
            href="/semifinal"
            className="bg-emerald-600 text-white p-8 rounded-2xl hover:bg-emerald-700 transition"
          >
            <div className="text-4xl">⚽</div>
            ...
            <p className="mt-3 text-emerald-100">
              Pronostica las semifinales.
            </p>
          </Link>

          <Link
            href="/final"
            className="bg-orange-600 text-white p-8 rounded-2xl hover:bg-orange-700 transition"
          >
            <div className="text-4xl">🏆</div>
            ...
            <p className="mt-3 text-orange-100">
              Pronostica el tercer lugar y la gran final.
            </p>
          </Link>
