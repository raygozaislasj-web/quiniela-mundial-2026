...
import { partidos } from "../data/semifinal";
  ...
  if (cargando) {
    ...
    <main className="max-w-7xl mx-auto p-6">
      ...
      <p className="text-gray-600 mb-8">
        Pronostica el marcador de las semifinales.
        Si el partido termina empatado,
        selecciona quién avanza a la Final.
      </p>
      ...
      <div className="mt-10 text-center">
        ...
        {!yaEntrego ? (
          ...
          <button
            ...
            className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 rounded-xl disabled:opacity-50"
          >
