...
import { partidos } from "../data/final";
  ...
  return (
    <main className="max-w-7xl mx-auto p-6">
      ...
      <p className="text-gray-600 mb-8">
        Selecciona quién gana el partido.
      </p>
      ...
      <div className="mt-10 text-center">
        ...
        {!yaEntrego ? (
          ...
          <button
            ...
            className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-4 rounded-xl disabled:opacity-50"
          >
