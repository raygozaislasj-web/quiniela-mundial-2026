...
import { partidos } from "../data/dieciseisavos";
  ...
  if (cargando) {
    ...
    <main className="max-w-7xl mx-auto p-6">
      ...
      <p className="text-gray-600 mb-8">
        Escribe el marcador de cada partido.
        Si hay empate aparecerá la opción
        para elegir quién avanza en penales.
      </p>
      ...
      <div className="mt-10 text-center">
        ...
        {!yaEntrego ? (
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl disabled:opacity-50"
          >
